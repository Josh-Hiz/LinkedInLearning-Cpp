...
//Challenge, rewrite the operator overloads in this pre-made file to work outside the
// class structure and allow for both left-hand side & right-hand side operations
